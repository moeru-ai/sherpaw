...
const server = await createServer({ configFile: false, root: resolve(root, 'packages/speaker-identification/tests/web'), server: { host: '127.0.0.1', port: 0, hmr: false, fs: { allow: [root] } } })
